...
@section('content')
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-12">
                <a href="{{route('admin.ideathon')}}" class="btn btn-sm btn-primary">Votlar</a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12">
                <label for="solucao_problema">Problema a ser solucionado</label>
                <input type="text" id="solucao_problema" class="form-control" disabled value="{{$grupo->solucao_problema}}">
            </div>
